...
\end{figure}
	...
	\underline{Définition} Étant donnée une carte de surface lisse $p$, la \underline{première forme fondamentale} ou \underline{métrique} est $$I_{u,v}= \eval{\begin{pmatrix} p_{u}\cdot p_{u} & p_{u}\cdot p_{v}\\ p_{v}\cdot p_{u}& p_{v}\cdot p_{v}\end{pmatrix}}_{(u,v)}  = \begin{pmatrix} E &F \\ F & G	\end{pmatrix}$$ 
